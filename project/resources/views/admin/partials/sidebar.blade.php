        ...
        <ul class="sidebar-menu mb-5">
                ...
                <li class="nav-item dropdown {{ menu(['admin.service*']) }}">
                        ...
                        <ul class="dropdown-menu">
                                <li class="{{ menu('admin.service.category.index') }}"><a class="nav-link"
                                                href="{{ route('admin.service.category.index') }}">@lang('Category')</a>
                                </li>
                                ...
                                <li class="{{ menu('admin.service.faq.index') }}"><a class="nav-link"
                                                href="{{ route('admin.service.faq.index') }}">@lang('Service Faq')</a>
                                </li>
                        </ul>
                </li>
                ...
                <li
                        ...
                        <ul class="dropdown-menu">
                                ...
                                <li class="{{ menu('admin.want.to.work') }}"><a class="nav-link"
                                                href="{{ route('admin.want.to.work') }}">@lang('Want to Work')</a></li>
                                ...
                                <li class="{{ menu('admin.counter.index') }}"><a class="nav-link"
                                                href="{{ route('admin.counter.index') }}">@lang('Counter Section')</a>
                                </li>
                                ...
                                <li class="{{ menu('admin.contact.section') }}"><a class="nav-link"
                                                href="{{ route('admin.contact.section') }}">@lang('Contact Section')</a>
                                </li>
                                ...
                                <li class="{{ menu('admin.features.index') }}"><a class="nav-link"
                                                href="{{ route('admin.features.index') }}">@lang('Feature Section')</a>
